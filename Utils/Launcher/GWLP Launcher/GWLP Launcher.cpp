...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	CreateRemoteThread(processInformation.hProcess, 0, 0,(LPTHREAD_START_ROUTINE)GetProcAddress( GetModuleHandleA("kernel32.dll") , "LoadLibraryA"), pStringInRemoteProcess, 0, 0);
